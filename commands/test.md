...
Examples:
- `/test --tdd` - Test-driven development workflow (tmux: test-watch window)
- `/test --coverage` - Generate coverage report (tmux: coverage session)
- `/test --watch` - Continuous test mode (tmux: persistent test session)
- `/test --integration` - Run integration tests (tmux: integration window)
- `/test --e2e` - Run end-to-end tests (tmux: e2e-tests session)
